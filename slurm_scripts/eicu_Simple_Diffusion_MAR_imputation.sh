#!/bin/bash
#SBATCH --job-name=eicu_Simple_Diffusion_MAR_imputation
#SBATCH --output=./slurm_outputs/eicu/imputation/eicu_imputation_Simple_Diffusion_MAR.out
#SBATCH --qos=normal
...
echo "eicu Simple_Diffusion MAR Imputation Start"
...
echo "eicu Simple_Diffusion MAR Imputation End"
