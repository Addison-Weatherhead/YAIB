#!/bin/bash
#SBATCH --job-name=miiv_Simple_Diffusion_BO_imputation
#SBATCH --output=./slurm_outputs/miiv/imputation/miiv_imputation_Simple_Diffusion_BO.out
#SBATCH --qos=normal
...
echo "miiv Simple_Diffusion BO Imputation Start"
...
echo "miiv Simple_Diffusion BO Imputation End"
