#!/bin/bash
#SBATCH --job-name=hirid_HyperImpute_BO_imputation
#SBATCH --output=./slurm_outputs/hirid/imputation/hirid_imputation_HyperImpute_BO.out
#SBATCH --qos=normal
...
echo "hirid HyperImpute BO Imputation Start"
...
echo "hirid HyperImpute BO Imputation End"
