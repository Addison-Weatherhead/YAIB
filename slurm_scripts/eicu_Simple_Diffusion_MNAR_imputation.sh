#!/bin/bash
#SBATCH --job-name=eicu_Simple_Diffusion_MNAR_imputation
#SBATCH --output=./slurm_outputs/eicu/imputation/eicu_imputation_Simple_Diffusion_MNAR.out
#SBATCH --qos=normal
...
echo "eicu Simple_Diffusion MNAR Imputation Start"
...
echo "eicu Simple_Diffusion MNAR Imputation End"
