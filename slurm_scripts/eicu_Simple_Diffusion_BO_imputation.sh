#!/bin/bash
#SBATCH --job-name=eicu_Simple_Diffusion_BO_imputation
#SBATCH --output=./slurm_outputs/eicu/imputation/eicu_imputation_Simple_Diffusion_BO.out
#SBATCH --qos=normal
...
echo "eicu Simple_Diffusion BO Imputation Start"
...
echo "eicu Simple_Diffusion BO Imputation End"
