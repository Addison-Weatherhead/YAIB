#!/bin/bash
#SBATCH --job-name=eicu_HyperImpute_BO_imputation
#SBATCH --output=./slurm_outputs/eicu/imputation/eicu_imputation_HyperImpute_BO.out
#SBATCH --qos=normal
...
echo "eicu HyperImpute BO Imputation Start"
...
echo "eicu HyperImpute BO Imputation End"
