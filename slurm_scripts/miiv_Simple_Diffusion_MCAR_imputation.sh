#!/bin/bash
#SBATCH --job-name=miiv_Simple_Diffusion_MCAR_imputation
#SBATCH --output=./slurm_outputs/miiv/imputation/miiv_imputation_Simple_Diffusion_MCAR.out
#SBATCH --qos=normal
...
echo "miiv Simple_Diffusion MCAR Imputation Start"
...
echo "miiv Simple_Diffusion MCAR Imputation End"
