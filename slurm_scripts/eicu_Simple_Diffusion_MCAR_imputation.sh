#!/bin/bash
#SBATCH --job-name=eicu_Simple_Diffusion_MCAR_imputation
#SBATCH --output=./slurm_outputs/eicu/imputation/eicu_imputation_Simple_Diffusion_MCAR.out
#SBATCH --qos=normal
...
echo "eicu Simple_Diffusion MCAR Imputation Start"
...
echo "eicu Simple_Diffusion MCAR Imputation End"
