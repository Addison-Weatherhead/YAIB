#!/bin/bash
#SBATCH --job-name=miiv_HyperImpute_MAR_imputation
#SBATCH --output=./slurm_outputs/miiv/imputation/miiv_imputation_HyperImpute_MAR.out
#SBATCH --qos=normal
...
echo "miiv HyperImpute MAR Imputation Start"
...
echo "miiv HyperImpute MAR Imputation End"
