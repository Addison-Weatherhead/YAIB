#!/bin/bash
#SBATCH --job-name=hirid_Simple_Diffusion_MAR_imputation
#SBATCH --output=./slurm_outputs/hirid/imputation/hirid_imputation_Simple_Diffusion_MAR.out
#SBATCH --qos=normal
...
echo "hirid Simple_Diffusion MAR Imputation Start"
...
echo "hirid Simple_Diffusion MAR Imputation End"
