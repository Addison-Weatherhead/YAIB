#!/bin/bash
#SBATCH --job-name=eicu_HyperImpute_MAR_imputation
#SBATCH --output=./slurm_outputs/eicu/imputation/eicu_imputation_HyperImpute_MAR.out
#SBATCH --qos=normal
...
echo "eicu HyperImpute MAR Imputation Start"
...
echo "eicu HyperImpute MAR Imputation End"
