#!/bin/bash
#SBATCH --job-name=hirid_Simple_Diffusion_BO_imputation
#SBATCH --output=./slurm_outputs/hirid/imputation/hirid_imputation_Simple_Diffusion_BO.out
#SBATCH --qos=normal
...
echo "hirid Simple_Diffusion BO Imputation Start"
...
echo "hirid Simple_Diffusion BO Imputation End"
