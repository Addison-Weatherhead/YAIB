#!/bin/bash
#SBATCH --job-name=miiv_Simple_Diffusion_MNAR_imputation
#SBATCH --output=./slurm_outputs/miiv/imputation/miiv_imputation_Simple_Diffusion_MNAR.out
#SBATCH --qos=normal
...
echo "miiv Simple_Diffusion MNAR Imputation Start"
...
echo "miiv Simple_Diffusion MNAR Imputation End"
